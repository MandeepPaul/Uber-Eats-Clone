const Message: React.FC<{ className?: string }> = (props) => {
  return (
    <div className={`my-2 ${props.className}`}>
      <h1 className="text-3xl font-bold mb-3 hidden md:block lg:hidden">
        All stores
      </h1>
      <section className=" grid grid-rows-2 grid-flow-col justify-start gap-x-2 md:justify-normal">
        <img
          className="row-span-2 justify-self-center md:justify-self-end self-center h-[40px] md:h-[50px] lg:h-[70px]"
